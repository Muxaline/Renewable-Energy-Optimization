...
•	It was observed that, There are 20000 data row entries with 41 Columns features in the training data and 5000 data row entries with 41 columns on the testing data. Overall constituting 25000 data row entries with 41 columns feature for both Training and Testing data.
